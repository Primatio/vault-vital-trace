...
/// Cuff blood-pressure reading entered by the operator (mmHg).
class BloodPressureReading {
  ...
  String get display => '$systolicMmhg/$diastolicMmhg';
  ...
  factory BloodPressureReading.fromJson(Map<String, dynamic> json) {
    return BloodPressureReading(
      systolicMmhg: json['systolic_mmhg'] as int? ?? 0,
      diastolicMmhg: json['diastolic_mmhg'] as int? ?? 0,
    );
  }
}

/// Start + end cuff BP captured around the 30s take (VitalVideos-style).
class SessionBloodPressure {
  final BloodPressureReading? start;
  final BloodPressureReading? end;

  const SessionBloodPressure({this.start, this.end});
  ...
  factory SessionBloodPressure.fromJson(Map<String, dynamic>? json) {
    if (json == null) return const SessionBloodPressure();
    return SessionBloodPressure(
  ...
  SessionBloodPressure copyWith({
    BloodPressureReading? start,
    BloodPressureReading? end,
  }) {
    return SessionBloodPressure(
...
class SessionMetadata {
  ...
  final String appVersion;
  final SessionBloodPressure bloodPressure;
  ...
  const SessionMetadata({
    ...
    required this.appVersion,
    this.bloodPressure = const SessionBloodPressure(),
  });
  ...
  SessionMetadata copyWith({
    ...
    String? appVersion,
    SessionBloodPressure? bloodPressure,
  }) {
  ...
  factory SessionMetadata.fromJson(Map<String, dynamic> json) {
    return SessionMetadata(
      ...
      appVersion: json['app_version'] as String? ??
          ...
          'unknown',
      bloodPressure: SessionBloodPressure.fromJson(
